...
This repository is a reusable template for a clean `docs/`-based control-plane scaffold. It is designed for a future SaaS product that acts as a project/product "brain" through a UI or local workflow. The product source has not been defined yet.
...
docs/workflows/      Repeatable orchestrator procedures
```
...
- **Orchestrator mode (default):** read `docs/` control-plane files, clarify the desired outcome, then create or update plans, feature specs, ADRs, prompts, workflows, and memory as needed.
...
3. Create or update a plan using `docs/plans/_template.md` when the work is non-trivial.
...
| ------------------------- | ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| New SaaS/product idea     | `docs/context/`, `docs/memory/`, `docs/decisions/`, `docs/architecture/`                                      | `docs/plans/`, `docs/features/`, `docs/decisions/`, `docs/prompts/` |
...
| Bootstrap another repo    | `docs/workflows/bootstrap-orchestrator.md`, `docs/prompts/shared/bootstrap-orchestrator-in-new-repo.prompt.md` | `docs/prompts/shared/`, `docs/workflows/`                        |

## Product Direction Notes

The expected product direction is a SaaS/app that provides an orchestrator brain through a UI. In a repo created from this template, the first durable step is to define the product through `docs/plans/`, `docs/features/`, and `docs/decisions/`; implementation code should follow only after those documents exist.
